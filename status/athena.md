...
- **Recent** (≤5):
  ...
  - 2026-07-27: 0003 absorbed signed line 0.4.0-alpha.1; binary-constant corrections shipped
  - 2026-07-27: bridge#3 MERGED; v0.1.0-alpha.1 published (tag + publish.yml green)
  - 2026-07-26: all five consumers proven drop-in (file: proofs)
