...
- **Doing today**: TASK-0002 Phase 1 spike measured, reported, and opened as draft PR #5; qjs/wazero runs upstream ProxyUtils, goja fails bundle load.
- **Blocked**: Phase 2 implementation waits only on zeus's §4 engine ruling; TASK-0001 items 1–4 are acked/done.
- **Next**: Await zeus §4 ruling for Phase 2; if it has not landed, continue loop with TASK-0005/TASK-0008.
- **Recent** (≤5):
