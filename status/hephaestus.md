...
- **Doing today**: production Sub-Store engine branch is in draft PR #6 with the upstream core builder/pin committed.
...
- **Next**: continue inside PR #6 with a tested QuickJS runtime wrapper that consumes the reproduced core bundle without network/fs bindings.
- **Recent** (≤5):
